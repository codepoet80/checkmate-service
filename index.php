...
?>
    ...
    <table style="margin-left:15%;margin-right:20%;font-size:small;">
        ...
        <tr><td width="22%" align="right"><b><a href="https://appcatalog.webosarchive.org/showMuseum.php?search=check+mate">webOS/LuneOS</a></b></td><td style="padding-left:18px">Versions built for legacy (mobile) webOS and modern LuneOS.</td></tr>
    </table>
